...
lengthen <- function(country) {
  ...
  #Takes length of column_name and arguments from long_questions
  country <- country %>% 
    select(pais, year, unique_id, column_name, answer, extra_id)
  return(country)
}
```
...
belize_category_unfactor <- belize_long_unfactor %>% left_join(unfactored_categories, by = 'column_name')

argentina_long_unfactor <- lengthen(argentina_unique_unfactor)
argentina_category_unfactor <- argentina_long_unfactor %>% left_join(unfactored_categories, by = 'column_name')
...
lengthen_factor <- function(country) {
  ...
  #Takes length of column_name and arguments from long_questions
  country <- country %>% 
    select(`pais-factor`, `year-factor`, unique_id, column_name, answer, extra_id)
  return(country)
}
```
...
belize_category_factor <- belize_long_factor %>% left_join(factored_categories, by = 'column_name')

argentina_long_factor <- lengthen_factor(argentina_unique_factor)
argentina_category_factor <- argentina_long_factor %>% left_join(factored_categories, by = 'column_name')

brazil_long_factor <- lengthen_factor(brazi_unique_factor)
brazil_category_factor <- brazil_long_factor %>% left_join(factored_categories, by = 'column_name')

chile_long_factor <- lengthe_factor(chile_unique_factor)
chile_category_factor <- chile_long_factor %>% left_join(factored_categories, by = 'column_name')

panama_long_factor <- lengthen_factor(panama_unique_factor)
panama_category_factor <- panama_long_factor %>% left_join(factored_categories, by = 'column_name')

paraguay_long_factor <- lengthen_factor(paraguay_unique_factor)
paraguay_category_factor <-  paraguay_long_factor %>% left_join(factored_categories, by = 'column_name')

peru_long_factor <- lengthen_factor(peru_unique_factor)
peru_category_factor <- peru_long_factor %>% left_join(factored_categories, by = 'column_name')
...
uruguay_category_factor <- uruguay_long_factor %>% left_join(factored_categories, by = 'column_name')

venezuela_long_factor <- lengthen_factor(venezuela_unique_factor)
venezuela_category_factor <- venezuela_long_factor %>% left_join(factored_categories, by = 'column_name')

bolivia_long_factor <- lengthen_factor(bolivia_unique_factor)
bolivia_category_factor <- bolivia_long_factor %>% left_join(factored_categories, by = 'column_name')

canada_long_factor <- lengthen_factor(canada_unique_factor)
canada_category_factor <- canada_long_factor %>% left_join(factored_categories, by = 'column_name')

colombia_long_factor <- lengthen_factor(colombia_unique_factor)
colombia_category_factor <- colombia_long_factor %>% left_join(factored_categories, by = 'column_name')

costa_long_factor <- lengthen_factor(costa_unique_factor)
costa_category_factor <- costa_long_factor %>% left_join(factored_categories, by = 'column_name')

ecuador_long_factor <- lengthen_factor(ecuador_unique_factor)
ecuador_category_factor <- ecuador_long_factor %>% left_join(factored_categories, by = 'column_name')

elsalvador_long_factor <- lengthen_factor(elsalvador_unique_factor)
elsalvador_category_factor <- elsalvador_long_factor %>% left_join(factored_categories, by = 'column_name')

guatemala_long_factor <- lengthen_factor(guatemala_unique_factor)
guatemala_category_factor <- guatemala_long_factor %>% left_join(factored_categories, by = 'column_name')

honduras_long_factor <- lengthen_factor(honduras_unique_factor)
honduras_category_unfactor <- honduras_long_unfactor %>% left_join(unfactored_categories, by = 'column_name')

mexico_long_factor <- lengthen_factor(mexico_unique_factor)
mexico_category_factor <- mexico_long_factor %>% left_join(factored_categories, by = 'column_name')

nicaragua_long_factor <- lengthen_factor(nicaragua_unique_factor)
nicaragua_category_factor <- nicaragua_long_factor %>% left_join(factored_categories, by = 'column_name')

usa_long_factor <- lengthen_factor(usa_unique_factor)
usa_category_factor <- usa_long_factor %>% left_join(factored_categories, by = 'column_name')
```
