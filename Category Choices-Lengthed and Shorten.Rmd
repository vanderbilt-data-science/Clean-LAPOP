...
unfactored_questions <- read_csv('/Users/lindsayhardy/Clean-LAPOP/questions unfactor.csv')
unfactored_questions <- unfactored_questions %>% select(column_name, question)
factored_questions <- read_csv('/Users/lindsayhardy/Clean-LAPOP/questions factor.csv')
factored_questions <- factored_questions %>% select(column_name, question)
```
...
belize_category_factor <- belize_category_factor %>% left_join(factored_categories, by = 'column_name')
...
aregentina_joined_factor <- union_all(argentina_long_factor, argentina16_long_factor)
aregentina_joined_factor <- aregentina_joined_factor %>%
  left_join(factored_categories, by = 'column_name')
aregentina_joined_factor <- aregentina_joined_factor %>%
  left_join(unfactored_questions, by = 'column_name')
...
#suriname_joined_factor <- suriname_joined_factor %>% left_join(factored_categories, by = 'column_name')
#suriname_joined_factor <- suriname_joined_factor %>% left_join(unfactored_questions, by = 'column_name')
...
guatemala_category_factor <- guatemala_long_factor %>% 
  left_join(factored_categories, by = 'column_name')
guatemala_category_factor <- guatemala_category_factor %>%
  left_join(unfactored_questions, by = 'column_name')
