...
# Structure
This section makes a unique ID format for all merged country dataframes. The 2016/17 files already contain a unique identifier, and we used this as the template for making the unique ID.

First, there is a function written for the unfactored countries that is then applied to all merged countries.
