...
```{r}
arg_uniq <- widen_unique_countries(countries_common_only, "Argentina")
bel_uniq <- widen_unique_countries(countries_common_only, "Belice")
first_combined <- rbind(arg_uniq, bel_uniq)
```
