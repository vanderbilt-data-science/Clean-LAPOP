...
---
Only really need to run these next two chunks
```{r}
...
```{r}
argentina_shrink_factor  <- shrink(argentina_factor)
belize_shrink_factor  <- shrink(belize_factor)
bolivia_shrink_factor  <- shrink(bolivia_factor)
brazil_shrink_factor  <- shrink(brazil_factor)
canada_shrink_factor  <- shrink(canada_factor)
chile_shrink_factor  <- shrink(chile_factor)
colombia_shrink_factor  <- shrink(colombia_factor)
costa_shrink_factor <- shrink(costa_factor)
ecuador_shrink_factor <- shrink(ecuador_factor)
elsalvador_shrink_factor <- shrink(elsalvador_factor)
guatemala_shrink_factor <- shrink(guatemala_factor)
#guyana_shrink_factor <- shrink(guyana_factor) Commented out because it is English-only
honduras_shrink_factor <- shrink(honduras_factor)
#jamaica_shrink_factor <- shrink(jamaica_factor) Commented out because it is English-only
mexico_shrink_factor <- shrink(mexico_factor)
nicaragua_shrink_factor <- shrink(nicaragua_factor)
panama_shrink_factor <- shrink(panama_factor)
paraguay_shrink_factor <- shrink(paraguay_factor)
peru_shrink_factor<- shrink(peru_factor)
suriname_shrink_factor <- shrink(suriname_factor)
usa_shrink_factor <- shrink(usa_factor_factor)
uruguay_shrink_factor <- shrink(uruguay_factor)
venezuela_shrink_factor <- shrink(venezuela_factor)
```
