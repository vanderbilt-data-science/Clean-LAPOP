...
suriname_joined <- suriname_long_unfactor %>%
  left_join(unfactored_questions, by = 'column_name')
...
#Suriname
suriname_long_factor <- lengthen_factor(suriname_unique_factor) 
suriname_joined_factor <- suriname_long_factor %>% left_join(factored_questions, by = 'column_name_factor')
...
```{r}
test <- complete %>% filter(wave < 2014)
