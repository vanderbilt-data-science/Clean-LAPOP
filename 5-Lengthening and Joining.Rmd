...
#Makes vector of desired waves
x <- c(2006,2008,2010,2012)
#Filters for the waves named in x
small <- complete %>%
  filter(category %in% x)

#Writes .csv
##This is the file that is more manageable for Tableau Public
write_csv(small, '2008-2012 LAPOP.csv')

##Has too many rows for Tableau Public, but contains the full long version.
