...
```{r}
argentina_uniquex <- full_id(argentina_shrinkx)
belize_uniquex <- full_id(belize_shrinkx)
bolivia_uniquex <- full_id(bolivia_shrinkx)
brazil_uniquex <- full_id(brazil_shrinkx)
canada_uniquex <- full_id(canada_shrinkx)
chile_uniquex <- full_id(chile_shrinkx)
colombia_uniquex <- full_id(colombia_shrinkx)
costa_uniquex <- full_id(costa_shrinkx)
ecuador_uniquex <- full_id(ecuador_shrinkx)
elsalvador_uniquex <- full_id(elsalvador_shrinkx)
guatemala_uniquex <- full_id(guatemala_shrinkx)
#guyana_uniquex <- full_id(guyana_shrinkx)
honduras_uniquex <- full_id(honduras_shrinkx)
#jamaica_uniquex <- full_id(jamaica_shrinkx)
mexico_uniquex <- full_id(mexico_shrinkx)
nicaragua_uniquex <- full_id(nicaragua_shrinkx)
panama_uniquex <- full_id(panama_shrinkx)
paraguay_uniquex <- full_id(paraguay_shrinkx)
peru_uniquex <- full_id(peru_shrinkx)
suriname_uniquex <- full_id(suriname_shrinkx)
usa_uniquex <- full_id(usa_shrinkx)
uruguay_uniquex <- full_id(uruguay_shrinkx)
venezuela_uniquex <- full_id(venezuela_shrinkx)
```
